...
///////////////////filtro wps///////////////////////////////
/*    var objWfstmp = {
      url: 'http://192.168.1.3/geoserver/geoweb/wfs',
      typeNS: 'geoweb',
      typeName: 'mexpop',
      crs: L.CRS.EPSG4326,
      geometryField: 'the_geom',
      filter: new L.Filter.GEQ('mex_pop', '100000'),
      maxFeatures: 1000,
      style: {
        color: 'purple',
        weight: 2
    ...
    console.log(objWfstmp)
    var filwfst = new L.WFST(objWfstmp).addTo(map);*/
///////////////////Grafica//////////////////////////////Aguas con la IP 
$('#dialog-about').dialog({
  modal: false, autoOpen: false, closeOnEsc: true, draggable: true,
  position: { my:'left top', at:'left+50 top+5', or:'#map' }
});
...
handleChange(document.getElementById("radio1"));  
});
...
var graphTarget= $("#chart1");
  //tipoGraph = bar,doughnut,line,radar,pie,polarArea
  ...
  url : URL,
    ...
    success : function (response) {
      ...
      onEachFeature: function (feature, layer){
        ...
        layer.bindPopup("<b> Condado: "+feature.properties.NAME+"</b><br/> Mexicanos: "+feature.properties.mex_pop+"</b><br/> Numero de Estado: "+feature.properties.STATEFP +"</b><br/> Condado y Estado: "+feature.properties.Geographic,popupOptions);
...
var flag = new LeafIcon({iconUrl: 'img/mexico.png'});
...
$.getJSON("poi/Dir_Consulados2.geojson", function (data) {
